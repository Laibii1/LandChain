...
export class MarketplaceClass {
  ...
  async createAuction(tokenId, startingPrice, duration) {
    try {
      ...
      await tx.wait();
      console.log(
        `Auction created for tokenId ${tokenId}. Transaction: ${tx.hash}`
      );
    } catch (error) {
      if (error.message.includes("ApprovalNotGivenToMarketplace")) {
        console.error(
          "Approval not given to marketplace. Please approve the marketplace to manage your NFTs."
        );
      } else {
  ...
  async endAuction(tokenId) {
    try {
      ...
      await tx.wait();
      console.log(
        `Auction ended for tokenId ${tokenId}. Transaction: ${tx.hash}`
      );
    } catch (error) {
  ...
  async createDirectSale(tokenId, price) {
    try {
      ...
      await tx.wait();
      console.log(
        `Direct sale created for tokenId ${tokenId}. Transaction: ${tx.hash}`
      );
    } catch (error) {
      if (error.message.includes("ApprovalNotGivenToMarketplace")) {
        console.error(
  ...
  async createRentSale(tokenId, price, duration) {
    try {
      ...
      await tx.wait();
      console.log(
        `Rent sale created for tokenId ${tokenId}. Transaction: ${tx.hash}`
      );
    } catch (error) {
      if (error.message.includes("ApprovalNotGivenToMarketplace")) {
        console.error(
  ...
  async buyDirectSale(tokenId, price) {
    try {
      ...
      await tx.wait();
      console.log(
        `Direct sale purchased for tokenId ${tokenId}. Transaction: ${tx.hash}`
      );
    } catch (error) {
  ...
  async cancelDirectSale(tokenId) {
    try {
      ...
      await tx.wait();
      console.log(
        `Direct sale canceled for tokenId ${tokenId}. Transaction: ${tx.hash}`
      );
    } catch (error) {
  ...
  async cancelRentSale(tokenId) {
    try {
      ...
      await tx.wait();
      console.log(
        `Rent sale canceled for tokenId ${tokenId}. Transaction: ${tx.hash}`
      );
    } catch (error) {
  ...
  async setNftContract(nftContractAddress) {
    try {
      ...
      await tx.wait();
      console.log(
        `NFT contract set to ${nftContractAddress}. Transaction: ${tx.hash}`
      );
    } catch (error) {
