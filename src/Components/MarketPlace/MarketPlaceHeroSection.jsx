  ...
  return (
    <section className="relative bg-[#F5F5F5] mt-5 md:py-20 text-center px-4 sm:px-8">
      ...
      <h1 className="text-xl sm:text-3xl font-extrabold text-black leading-tight mb-6 font-Inter font-semibold">
        Discover Secure{" "}
        <span className="border-b-2 border-[#D0482E] inline-block mt-2">
          Real Estate{" "}
        </span>{" "}
        <br />
        in the Digital Age
      ...
      <p className="max-w-5xl mx-auto text-gray-700 leading-relaxed text-base sm:text-md mb-10 font-ReemKufi">
        Browse and invest in tokenized properties with confidence. Landchain
        combines blockchain security with real-world value to make ownership
        seamless, transparent, and future-ready. Experience peace of
        mind—whether you're buying your first plot or expanding your portfolio.
      </p>
