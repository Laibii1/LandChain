  ...
  return (
    <footer className="bg-black text-white mt-20 px-8 pt-16 pb-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center justify-center text-center">
        ...
        {/* Quick Links */}
        <div className="flex flex-col items-center">
          <h3 className="text-lg font-semibold underline mb-2 font-ReemKufi">
            Quick Links
          </h3>

          <Link to="NFTDashboard" className="hover:underline font-ReemKufi">
            Home
          </Link>
          <Link to="/FetchNFT" className="hover:underline font-ReemKufi">
            Wallet
          </Link>
          <Link to="/DD" className="hover:underline font-ReemKufi">
            Mint NFT
          </Link>
          <Link to="/Marketplace" className="hover:underline font-ReemKufi">
            Market Place
          </Link>
          <Link to="/Profile" className="hover:underline font-ReemKufi">
            Profile
          </Link>
        </div>
        ...
        {/* Newsletter + Docs */}
        <div className="flex flex-col items-center ">
          <h3 className="text-lg font-semibold mb-2 font-ReemKufi font-bold text-left">
            ...
            {isSent && (
              <div className="fixed inset-0 flex items-center justify-center z-50">
                <div className="bg-black text-white px-10 py-8 rounded-lg shadow-lg flex flex-col items-center gap-5 border-[1px] border-white">
                  ...
                  <span className="text-md font-ReemKufi">
          ...
          <div className="mt-6">
            <h4 className="underline font-semibold mb-1 font-ReemKufi text-left">
              Documentation
            </h4>
      ...
      <div className="my-10 flex flex-col md:flex-row justify-center items-center gap-10 lg:gap-40 md:gap-40">
        <h4 className="font-bold text-md text-cenetr md:text-center font-Inter">
          TECHNOLOGICAL STACK
        </h4>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-700 pt-4 font-Inter">
        <p className="text-sm">
          @2025 LandChain
          <br />
          <span className="text-sm text-gray-500 underline mt-2 md:mt-0">
        ...
        <div className="flex gap-5 md:mt-0 m-2">
          ...
          >
            <img
              src={twitterIcon}
              alt="Twitter"
              className="h-7 hover:opacity-80 transition"
            />
          </a>
