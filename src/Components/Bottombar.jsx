      ...
      <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
          >
            <path d="M3 9a7 7 0 0 1 14 0h3.5A1.5 1.5 0 0 1 22 10.5V21a1.5 1.5 0 0 1-1.5 1.5h-17A1.5 1.5 0 0 1 2 21V10.5A1.5 1.5 0 0 1 3.5 9H7a7 7 0 0 1 14 0H3Zm5 5a3 3 0 0 0 6 0h5v6h-2v-4a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v4H5v-6h5Z" />
          </svg>
